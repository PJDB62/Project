...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 06:10 PM
...
-- Database: `newweb`
--
CREATE DATABASE IF NOT EXISTS `newweb` DEFAULT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci;
USE `newweb`;
...
CREATE TABLE `thanhvien` (
  ...
  `Quequan` varchar(255) COLLATE utf8_vietnamese_ci NOT NULL
...
--
-- Database: `nguyen cong`
--
CREATE DATABASE IF NOT EXISTS `nguyen cong` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nguyen cong`;

-- --------------------------------------------------------

--
-- Table structure for table `firstweb`
--

CREATE TABLE `firstweb` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `firstweb`
--

INSERT INTO `firstweb` (`id`, `gia`, `sdt`) VALUES
(1, '200000', '0904547863'),
(2, '900000', '0909222096'),
(3, '0909222096', '0909222096');
...
--
-- Indexes for table `firstweb`
--
ALTER TABLE `firstweb`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `firstweb`
--
ALTER TABLE `firstweb`
...
('root', '[{\"db\":\"webproduct\",\"table\":\"admin\"},{\"db\":\"webproduct\",\"table\":\"product\"},{\"db\":\"webproduct\",\"table\":\"catalog\"},{\"db\":\"webproduct\",\"table\":\"user\"},{\"db\":\"newweb\",\"table\":\"thanhvien\"},{\"db\":\"nguyen cong\",\"table\":\"firstweb\"}]');
...
('root', '2019-12-05 22:31:45', '{\"Console\\/Mode\":\"collapse\"}');
